...
function coakPokemons(callback) {

    let ivysaur = "https://pokeapi.co/api/v2/pokemon/2/"
    let charizard = "https://pokeapi.co/api/v2/pokemon/6/"
    let blastoise = "https://pokeapi.co/api/v2/pokemon/9/"
